  ...
  )
{
  ...
  // Power up TFP410 (set GPIO2 on TPS - for PandaBoard-xM)
  ...
  // Power up TFP410 (set GPIO 170 - for older PandaBoards)
  ...
  )
{
  ...
  DEBUG((EFI_D_INFO, "Enter INit Display\n"));
 ...
 DEBUG((EFI_D_INFO, "Enter hwInit Display\n"));
